...
db = client["Jurong-Electric"]
collection = db["Electricity"]

db_household = client["Jurong-Users"]
collection_household = db_household["Household"]

class ml_Jurong(ml_hougang_pb2_grpc.ml_HougangServicer):
...
def serve():
    ...
    ml_hougang_pb2_grpc.add_ml_HougangServicer_to_server(ml_Jurong(), server)
    port = '50056'
